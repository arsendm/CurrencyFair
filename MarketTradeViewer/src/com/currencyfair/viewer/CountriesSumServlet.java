...
/**
 * 
 * Servlet used to load countries information from RESTful API and refresh graphics via AJAX
 * 
 */
@WebServlet("/CountriesSumServlet")
public class CountriesSumServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CountriesSumServlet() {
        super();
	...
	public String generateJSONData(String currencyFrom, String currencyTo) throws IOException {
		...
		// RESTful API - Service - GetCountriesSum
		String urlParameters = "currencyFrom=" + currencyFrom + "&currencyTo=" + currencyTo;

		String request = 
			"http://localhost:8080/API/rest/message/getCountriesSum";
		...
		JSONoutput = "{\"countries\":" + JSONoutput + "}";
